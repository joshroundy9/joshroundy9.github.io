...
var INPUTTEXT = "Barcode";
//drawBarcode(INPUTTEXT);

TEXTBOX.addEventListener("onsubmit", (event) => {
    INPUTTEXT = TEXTBOX.value;
    if(INPUTTEXT.length < 25)
    drawBarcode(INPUTTEXT);
    else alert("Your text is too long");
    TEXTBOX.value = "";
});
...
function drawBarcode(NEWTEXT)
{
    JsBarcode("#barcode",NEWTEXT,{font: "MONTSERRAT", fontSize: "10"});
}